 ...
 * 
 */
package com.jeenwagonweb.user.controller;
...
import com.jeenwagonweb.security.util.SecurityUtil;
import com.jeenwagonweb.user.dto.RegistrationForm;
import com.jeenwagonweb.user.entity.User;
import com.jeenwagonweb.user.service.DuplicateEmailException;
import com.jeenwagonweb.user.service.UserAccountService;
...
public class RegistrationController {
    ...
    @Autowired
    public RegistrationController(UserAccountService service) {
