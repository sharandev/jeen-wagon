...
public class JeanWagonUserDetails extends SocialUser{
    ...
    public JeanWagonUserDetails(String username, String password,Collection<? extends GrantedAuthority> authorities) {
    ...
    public static class Builder {
        ...
        public JeanWagonUserDetails build() {
        	JeanWagonUserDetails user = new JeanWagonUserDetails(username, password, authorities);
